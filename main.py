...
def countRectangles(points):
    ...
    for i in range(len(points)):
        for j in range(i + 1, len(points)):
            ...
            # check if the other two points are in the list of points
            p3 = (p1[0], p2[1])
            p4 = (p2[0], p1[1])

            if p3 in points_set and p4 in points_set:  # if all the points are in the list of points increase the number of rectangles
                rectangles += 1
